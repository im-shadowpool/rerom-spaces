        ...
        <div className="hero-stats">
          <div className="container">
            ...
            <div className="stat">
              ...
              <div className="stat-info">
                <Copy delay={0.45}>
                  <p>Experience in Web & App Development</p>
                </Copy>
              </div>
            </div>
          </div>
          ...
          <div className="what-we-do-header">
            <Copy delay={0.1}>
              <h1>
                ...
                At ReromSpaces, we blend creativity, technology, and strategy to
                build digital solutions that truly matter.
              </h1>
            </Copy>
          </div>
